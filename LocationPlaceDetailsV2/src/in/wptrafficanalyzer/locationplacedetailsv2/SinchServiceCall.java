...
public class SinchServiceCall extends Service {
	  private static final String APP_KEY = "d60fc1d2-3b43-4a4c-a3a9-4c1b7a2adf5a";
	    private static final String APP_SECRET = "dLYbmw8/KUaByNdvrw0czQ==";
    private static final String ENVIRONMENT = "sandbox.sinch.com";

    public static final String CALL_ID = "CALL_ID";
    static final String TAG = SinchServiceCall.class.getSimpleName();
    ...
    public class SinchServiceInterface extends Binder {
        ...
        public boolean isStarted() {
            return SinchServiceCall.this.isStarted();
        }
    ...
    private class SinchCallClientListener implements CallClientListener {
        ...
        public void onIncomingCall(CallClient callClient, Call call) {
            ...
            Intent intent = new Intent(SinchServiceCall.this, IncomingCallScreenActivity.class);
            intent.putExtra(CALL_ID, call.getCallId());
            intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            SinchServiceCall.this.startActivity(intent);
        }
    }
